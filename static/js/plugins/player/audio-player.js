$(function() {
    ...
    if ($('.audio-player').length) {
        ...
        var myPlaylist = new jPlayerPlaylist({
			...
			image : "static/images/weekly/song2.jpg",	
            title: "Your Face",
            artist: "Ministry",
			...
			image : "{% static 'images/weekly/song3.jpg' %}",	
            title: "Cyber Sonnet",
            artist: "You Am I",
			...
			image : "{% static 'images/weekly/song4.jpg' %}",	
            title: "Tempered Song",
            artist: "Shelter",
			...
			image : "{% static 'images/weekly/song5.jpg' %}",	
            title: "Hidden",
            artist: "Bad Religion",
			...
			image : '{% static "images/weekly/song6.jpg" %}',	
            title: "Lentement",
            artist: "Apollo 440",
			...
			image : '{% static "images/weekly/song7.jpg" %}',	
            title: "Lismore",
			...
			image : '{% static "images/weekly/song8.jpg" %}',	
			...
			image : "{% static 'images/weekly/song9.jpg' %}",	
            title: "Beside Me",
            artist: "Friendly Fires ",
